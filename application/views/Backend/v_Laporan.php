        ...
        <div class="box-body">
            <div class="row" style="margin-bottom: 15px;">
                ...
                <div class="col-md-3" id="wrap-filter-bulan" style="display:none;">
                    <input type="text" autocomplete="off" placeholder="Pilih Bulan" class="form-control monthpicker" id="filter_bulan">
                </div>
        ...
        <div class="modal-body">
            ...
            <div id="print-bulan-fields" style="display: none;">
                <div class="form-group">
                    ...
                    <div><input type="text" autocomplete="off" placeholder="Pilih Bulan" class="form-control monthpicker" name="print_bulan"></div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#modal-print').on('show.bs.modal', function(e) {
            // Only handle if the event was triggered by the modal itself, not by datepicker
            if (e.target !== this) {
                return;
            }
