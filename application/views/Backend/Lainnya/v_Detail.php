<div class="col-xs-12">
	<div class="box box-primary">
        <div class="box-header">
            <div class="col-sm-2">
<?php $kls= $this->db->query("SELECT DISTINCT DATE(tgl_pemasukan) AS tgl_filter, DATE_FORMAT(tgl_pemasukan,'%d-%m-%Y') AS t FROM pemasukan ORDER BY tgl_pemasukan DESC")->result() ?>
