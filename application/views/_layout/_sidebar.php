...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview <?php if ($aktif == 'SPP' || $aktif == 'Pendaftaran' || $aktif == 'Ujian' || $aktif == 'Buku' || $aktif == 'Baju' || $aktif == 'Lainnya' ) echo 'active' ?>">
        ...
        <ul class="treeview-menu">
            ...
            <li class = "<?php echo activate_menu('Buku')?>"><a href="<?= base_url()?>Buku"><i class="fa fa-circle-o"></i>Uang Buku</a></li>
            <li class = "<?php echo activate_menu('Baju')?>"><a href="<?= base_url()?>Baju"><i class="fa fa-circle-o"></i>Uang Baju</a></li>
             <li class = "<?php echo activate_menu('Lainnya')?>"><a href="<?= base_url()?>Lainnya"><i class="fa fa-circle-o"></i>Pemasukan Lainnya</a></li>
        </ul>
    </li>
    <li class = "<?php echo activate_menu('Pengeluaran')?>"><a href="<?= base_url()?>Pengeluaran"><i class="fa fa-level-up"></i> <span>Kas Keluar</span><span class="pull-right-container"></span></a></li>
